$(document).ready(function() {
    /**
     * Si el usuario no se puede imprimir por pantalla a los alumno se imprime por consola el error
     */
    ...
    $("#verAlumnos").click(function () {
        ...
        request.done(function (response) {
            /**
             * Para imprimir en pantalla las tarjetas de los alumnos disponibles en la base de datos en Personal.php
             * @type {array}
             */
                      ...
                      <div class="iq-card">
                         <div class="iq-card-header d-flex justify-content-between">
                            <div class="iq-header-title">
                               <h4 class="card-title">Enfermer@s</h4>
                            </div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                           <div class="modal-content">
                                              ...
                                              <div class="modal-footer">
                                                 ...
                                                 <button type="button" class="btn btn-primary" id="${element.id_usuario}">Aceptar</button>
                                              </div>
                                           </div>
                                        </div>
                                     </div>
